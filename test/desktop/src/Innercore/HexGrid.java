...
public class HexGrid {
    ...
    public HexGrid() {
        hexTexture = new Texture(Gdx.files.internal("D:\\Software Enj 2\\COMP20050-SEP2-13\\test\\desktop\\src\\Innercore\\hex_tex.png")); // Change the path to your hex texture
